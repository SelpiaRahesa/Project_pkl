    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('pkgAtasan.update', $pkgAtasan->id) }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control"  @error('pkgAtasan') is-invalid @enderror"
                                name="pertanyaan" value="{{ old('pkgAtasan', $pkgAtasan->pertanyaan) }}" rows="3" placeholder="Masukan Pertanyaan"
                                required>
                            @error('pkgAtasan')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
