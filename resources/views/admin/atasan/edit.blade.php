    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('atasan.update', $atasan->id) }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_kompetensi') is-invalid @enderror" name="nama_kompetensi"
                                value="{{ old('atasan', $atasan->nama_kompetensi) }}" placeholder="Nama Kompetensi" required>
